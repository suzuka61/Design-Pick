...
export function RippleGridBg({
  ...
  useEffect(() => {
    ...
    const mouseInfluenceRef = { value: 0 };
    ...
    const handleMouseEnter = () => { if (mouseInteraction) mouseInfluenceRef.value = 1.0; };
    const handleMouseLeave = () => { if (mouseInteraction) mouseInfluenceRef.value = 0.0; };
    ...
    const render = (t: number) => {
      ...
      uniforms.mouseInfluence.value += (mouseInfluenceRef.value - uniforms.mouseInfluence.value) * 0.05;
